...
const lc_unidadconstruccionController = require('../controllers/lc_unidadconstruccionController');
...
router.get('/unidadconstruccion/:id', lc_unidadconstruccionController.getunidadconstruccionById);
